    ...
    <div>
        <form @submit.prevent="addCar()">
            ...
            <div class="form-group"> 
                ...
                <input type="number" class="form-control" v-model="car.numberOfDoors">
            </div>
        <div class="form-group"> 
        ...
        <input type="radio" name="engine" value="diesel" v-model="car.engine"> Diesel<br>
        ...
        <button @click="preview" class="btn btn-danger">Preview</button>
